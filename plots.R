...
for(i in 1:4){
  ...
  for(j in 1:6){
    ...
    df_t1 = read.csv(paste("t3",theta3[i],"/df_","t1_",maxT[j],".csv",sep=""))
    ...
    df_t1 = read.csv(paste("t3",theta3[i],"/df_","t1_cp_",maxT[j],".csv",sep=""))
...
ggsave("plots_t1.png",g,width=10,height=10)
