...
for(j in 1:length(maxT)){
  ...
  for(it in 1:its){
    ...
    write.csv(df_t1,paste("ct3005/df_","t1_",maxT[j],".csv",sep=""))
    write.csv(df_t2,paste("ct3005/df_","t2_",maxT[j],".csv",sep=""))
    ...
    write.csv(df_t1_cp,paste("ct3005/df_","t1_cp_",maxT[j],".csv",sep=""))
    write.csv(df_t2_cp,paste("ct3005/df_","t2_cp_",maxT[j],".csv",sep=""))
